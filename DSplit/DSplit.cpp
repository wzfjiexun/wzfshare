...
BEGIN_MESSAGE_MAP(CDSplitApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDSplitApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CDSplitApp::CDSplitApp() noexcept
{
	...
	SetAppID(_T("DSplit.AppID.NoVersion"));
